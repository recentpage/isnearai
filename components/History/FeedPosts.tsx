...
import EditMenu from "../../components/partials/DropdownEditMenu";
    ...
    <>
      ...
      <div className="bg-white shadow-md rounded border border-slate-200 p-5">
        ...
        <header className="flex justify-between items-start space-x-3 mb-3">
          ...
          <div className="flex items-start space-x-3">
            <img
              ...
              src={"/images/avatars/avatar-03.jpg"}
              width="40"
              height="40"
              alt="User 03"
            />
        ...
        <div className="text-sm text-slate-800 space-y-2 mb-5">
          <p>👋</p>
          <p>
            It`&apos`s more likely that people reading your blog will opt in
            with their email addresses if you give them something highly
            relevant in return. Ditch that too-general lead magnet and create
            `&rdquo;`content upgrades`&rdquo;` for your highest-traffic
            articles.
          </p>
          <p>Thread 👇</p>
        </div>
              ...
              <div className="flex items-start space-x-3">
                ...
                <div>
                  ...
                  <div className="text-sm">
                    ...
                    Reading through and really enjoying by Arvid.
                  </div>
                </div>
              </div>
            </li>
            ...
            <li className="p-3 bg-slate-50 rounded">
              <div className="flex items-start space-x-3">
                ...
                <div>
                  ...
                  <div className="text-sm">
                    Depends on the company youre running, but if I had to choose
                    just one book, itd be The Personal MBA by Josh Kaufman.
                  </div>
                </div>
              </div>
            </li>
