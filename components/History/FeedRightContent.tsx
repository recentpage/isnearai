              ...
              <ul className="space-y-3">
                  ...
                  <div className="flex items-center justify-between">
                    <div className="grow flex items-center">
                      <div className="relative mr-3">
                        <img className="w-8 h-8 rounded-full" src={'/images/avatars/avatar-03.jpg'} width="32" height="32" alt="Group 01" />
                      </div>
                ...
                <li>
                  <div className="flex items-center justify-between">
                    <div className="grow flex items-center">
                      <div className="relative mr-3">
                        <img className="w-8 h-8 rounded-full" src={'/images/avatars/avatar-03.jpg'} width="32" height="32" alt="Group 02" />
                      </div>
                      <div className="truncate">
                ...
                <li>
                  <div className="flex items-center justify-between">
                    <div className="grow flex items-center">
                      <div className="relative mr-3">
                        <img className="w-8 h-8 rounded-full" src={'/images/avatars/avatar-03.jpg'} width="32" height="32" alt="Group 03" />
                      </div>
                      <div className="truncate">
                ...
                <li>
                  <div className="flex items-center justify-between">
                    <div className="grow flex items-center">
                      <div className="relative mr-3">
                        <img className="w-8 h-8 rounded-full" src={'/images/avatars/avatar-03.jpg'} width="32" height="32" alt="Group 04" />
                      </div>
                      <div className="truncate">
              ...
              <ul className="space-y-3">
                <li>
                  <div className="flex items-center justify-between">
                    <div className="grow flex items-center">
                      <div className="relative mr-3">
                        <img className="w-8 h-8 rounded-full" src={'/images/avatars/avatar-03.jpg'} width="32" height="32" alt="User 02" />
                      </div>
                      <div className="truncate">
                ...
                <li>
                  <div className="flex items-center justify-between">
                    <div className="grow flex items-center">
                      <div className="relative mr-3">
                        <img className="w-8 h-8 rounded-full" src={'/images/avatars/avatar-03.jpg'} width="32" height="32" alt="User 04" />
                      </div>
                      <div className="truncate">
                ...
                <li>
                  <div className="flex items-center justify-between">
                    <div className="grow flex items-center">
                      <div className="relative mr-3">
                        <img className="w-8 h-8 rounded-full" src={'/images/avatars/avatar-03.jpg'} width="32" height="32" alt="User 05" />
                      </div>
                      <div className="truncate">
                ...
                <li>
                  <div className="flex items-center justify-between">
                    <div className="grow flex items-center">
                      <div className="relative mr-3">
                        <img className="w-8 h-8 rounded-full" src={'/images/avatars/avatar-03.jpg'} width="32" height="32" alt="User 01" />
                      </div>
                      <div className="truncate">
